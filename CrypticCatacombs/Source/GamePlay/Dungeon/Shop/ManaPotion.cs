...
{
    public class ManaPotion : Animated2d
    {
        public bool done;
		public DismissableMessage message;

		public ManaPotion(string PATH, Vector2 POS)
		...
		public virtual void ConfirmPurchase(object INFO)
		{
			...
			GameGlobals.user.wizard.mana = Math.Min(GameGlobals.user.wizard.mana + 50, GameGlobals.user.wizard.manaMax);
			GameGlobals.user.gold -= 5;
		}
