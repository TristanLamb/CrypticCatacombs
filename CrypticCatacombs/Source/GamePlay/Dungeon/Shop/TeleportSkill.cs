...
{
    public class TeleportSkill : Animated2d
    {
        public bool done;
		public DismissableMessage message;

		public TeleportSkill(string PATH, Vector2 POS)
        ...
        public virtual void Update(Vector2 OFFSET)
        {
			if (Globals.mouse.LeftClick() && Hover(OFFSET))
			{
				if (GameGlobals.user.gold >= 10)
				{
					...
					new Vector2(300, 150),
					"Are you sure you want to buy the skill: TELEPORT for 10G",
					Color.Black,
					true,
		...
		public virtual void ConfirmPurchase(object INFO)
		{
			...
			GameGlobals.user.wizard.purchasedTeleportSkill = true;
