...
namespace CrypticCatacombs
{
    public class Animated2d : Basic2d
    {
        ...
        public override void Draw(Vector2 screenShift, SpriteEffects spriteEffect)
        {
            ...
            if(frameAnimations && frameAnimationList[currentAnimation].Frames > 0)
            {
                ...
                frameAnimationList[currentAnimation].Draw(myModel, dims, frameSize, screenShift, pos, rotation, color, spriteEffect);
